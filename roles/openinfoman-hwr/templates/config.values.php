 ...
 */
$i2ce_site_i2ce_path = "/opt/ihris/i2ce";


/**
 * the dsn to connect to your databse
 */
$i2ce_site_dsn = 'mysql://ihris:{{ mysqluserpwd }}@127.0.0.1/csd_hwr' ;
 ...
 */
$i2ce_site_module_config = "/opt/ihris/openhie-pr/sites/basex/CSD-ProviderRegistry.xml";
